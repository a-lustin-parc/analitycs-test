...
Если скидка в числовом выражении, то просто отображаем какую-то хуйню.	это размер охуенной скидки указанной в основных параметрах счета
...
После создания счета отправляем письмо пользователю о том, какой он охуенный чел.
...
Заполнить email всех участников, в поле email. 
